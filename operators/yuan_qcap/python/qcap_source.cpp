...
class PyQCAPSourceOp : public QCAPSourceOp {
 public:
  ...
  PyQCAPSourceOp(Fragment* fragment, const py::args& args,
                 const std::string& device = "SC0710 PCI"s,
                 const std::string& image_directory = ""s,
                 const std::string& image_no_signal = ""s,
                 const std::string& image_no_device = ""s,
                 const std::string& image_no_sdk = ""s,
                 uint32_t channel = 0,
      ...
      : QCAPSourceOp(ArgList{Arg{"device", device},
                             ...
                             Arg{"image_no_device", image_no_device},
                             Arg{"image_no_sdk", image_no_sdk},
                             Arg{"channel", channel},
                             Arg{"width", width},
                             Arg{"height", height},
...
PYBIND11_MODULE(_qcap_source, m) {
  ...
  py::class_<QCAPSourceOp, PyQCAPSourceOp, GXFOperator, std::shared_ptr<QCAPSourceOp>>(
      ...
      .def(py::init<Fragment*,
           ...
           "image_directory"_a = ""s,
           "image_no_signal"_a = ""s,
           "image_no_device"_a = ""s,
           "image_no_sdk"_a = ""s,
           "channel"_a = 0,
           "width"_a = 3840,
           "height"_a = 2160,
