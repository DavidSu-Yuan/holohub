...
// Constructor
PYDOC(QcapHSBOp, R"doc(
Operator to get a video stream from an YUAN High-Tech capture card.
)doc")

// PyQcapHSBOp Constructor
PYDOC(QcapHSBOp_python, R"doc(
Operator to get a video stream from an YUAN High-Tech capture card.
...
hololink_ip : str, optional
    hololink ip of hsb.
hololink_mac : str, optional
    hololink mac of hsb.
ibv_name : str, optional
    ibv name of hsb.
ibv_port : int, optional
    ibv port of hsb.
width : int, optional
