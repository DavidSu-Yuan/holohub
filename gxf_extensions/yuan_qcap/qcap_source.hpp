 ...
 */
#ifndef NVIDIA_HOLOSCAN_GXF_EXTENSIONS_QCAP_SOURCE_HPP_
#define NVIDIA_HOLOSCAN_GXF_EXTENSIONS_QCAP_SOURCE_HPP_
...
enum {
  ...
  PIXELFORMAT_YV12 =
      0x32315659,  // 0x32315659 -> MAKEFOURCC('Y', 'V', '1', '2') (4:2:0 | 08 BITS) (Y V U)
  PIXELFORMAT_I420 =
      0x30323449,  // 0x30323449 -> MAKEFOURCC('I', '4', '2', '0') (4:2:0 | 08 BITS) (Y U V)
  PIXELFORMAT_NV12 =
      0x3231564E,  // 0x3231564E -> MAKEFOURCC('N', 'V', '1', '2') (4:2:0 | 08 BITS) (Y C)
  PIXELFORMAT_Y800 =
      0x30303859,  // 0x30303859 -> MAKEFOURCC('Y', '8', '0', '0') (4:0:0 | 08 BITS) (Y)
...
class QCAPSource : public gxf::Codelet {
 public:
  QCAPSource();
...
#endif  // NVIDIA_HOLOSCAN_GXF_EXTENSIONS_QCAP_SOURCE_HPP_
